...
- -- multi label classification   -- vision tasks
- -- single column regression
- -- multi column regression
- -- holdout   --for time series
"""
...
if __name__ == "__main__":
    ...
    #next step is to build a fold mapping where we can train on a specific data and validate on a specific batch
